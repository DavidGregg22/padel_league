    ...
    <x-slot name="header">
        <div class="flex flex-wrap justify-between items-center gap-3">
            ...
            <div class="flex items-center gap-3 flex-wrap">
                @if($seasons->count() > 1)
                <select onchange="window.location='/season/'+this.value"
            ...
            @else
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="bg-blue-900 rounded-lg shadow overflow-hidden">
                        <div class="bg-teal-600 px-5 py-3.5">
                                ...
                                <tbody class="divide-y divide-blue-800">
                                    @forelse($singlesStandings as $i => $row)
                                        <tr class="{{ $i === 0 ? 'bg-blue-800/60' : 'hover:bg-blue-800/40' }}">
                                            <td class="px-4 py-3 text-blue-400 font-medium">{{ $i + 1 }}</td>
                    ...
                    {{-- Doubles Table --}}
                    <div class="bg-blue-900 rounded-lg shadow overflow-hidden">
                        <div class="bg-amber-500 px-5 py-3.5">
                ...
                <div class="mt-5 text-center">
                    <a href="{{ route('league.season', $season) }}" class="text-teal-400 hover:text-teal-300 text-sm font-medium">
