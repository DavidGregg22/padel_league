<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-lg text-blue-100">Create Season</h2>
    </x-slot>
            ...
            <form method="POST" action="{{ route('admin.seasons.store') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                        class="mt-1 block w-full bg-blue-800 border-blue-700 text-white rounded-md shadow-sm focus:ring-teal-500 focus:border-teal-500 placeholder-blue-500"
                ...
                <div class="flex justify-end gap-3 pt-2">
                    <a href="{{ route('admin.seasons.index') }}" class="text-blue-400 hover:text-blue-200 text-sm">Cancel</a>
