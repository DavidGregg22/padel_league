                    ...
                    <tbody class="divide-y divide-blue-800">
                        @forelse($seasons as $season)
                            <tr class="hover:bg-blue-800/40">
                                <td class="px-6 py-4 font-medium text-white">{{ $season->name }}</td>
                                <td class="px-6 py-4 text-center text-blue-300">{{ $season->year }}</td>
                                <td class="px-6 py-4 text-center">
                                    @if($season->active)
                                        <span class="bg-teal-900/60 text-teal-300 border border-teal-700 px-2 py-1 rounded-full text-xs font-semibold">Active</span>
                                    @else
                                        <span class="bg-blue-800 text-blue-400 px-2 py-1 rounded-full text-xs">Inactive</span>
                                    @endif
                                </td>
                        ...
                        @empty
                            <tr><td colspan="4" class="px-6 py-8 text-center text-blue-400">No seasons yet.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
